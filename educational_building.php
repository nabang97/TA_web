  ...
  <body>
    ...
    <script>
      ...
      function initMap() {
        ...
        var batas = new google.maps.Data();
                           layernya.loadGeoJson('https://gis-kotogadang.herokuapp.com/datapendidikan.php');
                           batas.loadGeoJson('https://gis-kotogadang.herokuapp.com/batasnagari.php');
                           batas.setMap(map);
                           layernya.setMap(map);
      }
